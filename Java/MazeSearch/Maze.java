...
/**
 * The Maze class represents a maze and provides methods for generating, drawing, and accessing cells in the maze.
 */
public class Maze {

    public static final double MAZE_LEFT = 10;  // X-coordinate of the top-left corner of the maze
    public static final double MAZE_TOP = 10;   // Y-coordinate of the top-left corner of the maze
    public static final double CELL_SIZE = 20;   // Size of each cell in the maze
    private List<String> directions = Arrays.asList("NORTH", "SOUTH", "EAST", "WEST");  // List of possible directions
    private int size;  // Size of the maze (number of cells in each dimension)
    private MazeCell[][] cells;  // 2D array to represent the cells in the maze
    private MazeCell goal;  // The goal cell in the maze
