 ...
 * It reports all the points that the method should find, followed by the
 *  actual path that the method found. If they don't match, then there is something
 *  wrong with the code - either it doesn't build the graph correctly, or
 *  the AStar method is not correct.
 *
 *  Note, this testing program is not a full test of the articulation points method
