...
public class OrganisationChart {
    ...
    public static void main(String[] arguments) {
        ...
        oc.setupGUI();
        // Uncomment this to create a custom Organisation Chart
        // oc.initialiseChart();
        oc.makeTestTree();
     ...
     * Does a recursive search of the subtree whose root is the given Position.
    ...
    private void movePosition(Position pos, Position target) {
        if ((pos == null) || (target == null)) { //invalid arguments.
            return;
        }
