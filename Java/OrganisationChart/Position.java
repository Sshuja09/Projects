...
public class Position {
    ...
    public void addToTeam(Position newMemb){
        ...
        newMemb.manager = this; //Sets the manager of the new member
        this.team.add(newMemb); // Adds the new member to the managers team
    }
    ...
    public void removeFromTeam(Position teamMemb){
        teamMemb.manager = null; // Set the team member manager to null
        team.remove(teamMemb); // Removes the team member from the Manager team
    }
    ...
    /** Returns true if this position is managing any other positions */
    ...
    /**
     * Returns true if the point (x,y) is on top of where
